...
if (os == "windows"){
	...
	shell(tempbat,wait=wait)
		...
		} else {system(paste("java -Xmx",set.memory,"g -jar ",path.imagej,"ImageJ.app/Contents/Resources/Java/ij.jar -ijpath ",path.imagej," ",exe,tempmacro," ",set.directory,sep=""),wait=wait)
}
}
